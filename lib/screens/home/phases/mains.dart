                          ...
                          RichText(
                            text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  ...
                                  const TextSpan(
                                    text:'• Language Papers (Indian language and English)\n',
                                    style:TextStyle(fontWeight: FontWeight.w500),

                                  ),
                                  const TextSpan(
                                    text:'Although both these papers are only qualifying in nature, candidates should not be complacent as if they fail to score below 25% in either of them, their remaining answer sheets won’t even be evaluated. Both the papers follow a similar pattern of questions as given below.\n',
                                    style:TextStyle(fontWeight:FontWeight.normal),
                                  ),
                                  const TextSpan(
                                      text:'• One essay question for 100 marks – candidates have to select one out of a few given topics\n• Reading comprehension and related five-six questions for a total of 60 marks\n• Precis writing for 60 marks – the answer sheet will have a separate grid structure where this has to be written\n• Translation from English to chosen language for 20 marks\n• Translation from chosen language to English for 20 marks\n• Grammar and basic language usage such as synonyms, sentence correction etc. for a total of 40 marks',
                                    style: TextStyle(fontWeight:FontWeight.normal),
                                  ),
                                  const TextSpan(
                                      text:'Essay',
